...
export const PriceDatabase = () => {
  useDocumentHead({
    title: 'Base de Données des Prix de Villas à Dubaï | Tendances Trimestrielles par Quartier | InvestDubai',
    description: 'La base de données la plus complète des prix de villas à Dubaï par quartier. Tendances trimestrielles, croissance sur 5 ans et prix records pour Palm Jumeirah, Jumeirah Islands, Al Barari et plus.',
    canonical: 'https://www.investdubai.com/fr/price-database',
  });
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <head>
        <title>Base de Données des Prix Immobiliers à Dubaï | Prix des Villas par Quartier | InvestDubai</title>
        <meta name="description" content="Base de données complète des prix immobiliers à Dubaï. Suivez les prix des villas dans plus de 25 quartiers dont Palm Jumeirah, Emirates Hills, Dubai Marina. Données historiques et tendances du marché." />
        <meta name="keywords" content="prix immobilier Dubaï, prix villas Dubaï, Palm Jumeirah prix, Emirates Hills prix, marché immobilier Dubaï, investissement immobilier Dubaï" />
        <link rel="canonical" href="https://investdubai.com/fr/price-database" />
      </head>
      ...
      <section className="relative pt-32 pb-16 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-12 relative z-10 text-center">
          ...
          <p className="text-body-lg text-gray-400 max-w-2xl mx-auto mb-12">
            InvestDubai a créé la base de données la plus complète pour comprendre les prix des villas et les taux d'appréciation par quartier
          </p>
      ...
      <section className="py-10 border-b border-zinc-800/80">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
          ...
          <div className="mb-10 flex flex-col items-center">
            <p className="text-label text-zinc-500 mb-4">Catégorie</p>
          ...
          {/* Neighborhood Grid */}
          <div>
            <p className="text-label text-zinc-500 mb-4 text-center">Quartier</p>
            ...
            {filteredNeighborhoods.length === 0 && (
              <div className="text-center py-8">
                <p className="text-zinc-500">Aucun quartier ne correspond à votre recherche.</p>
              </div>
            )}
          </div>
        </div>
