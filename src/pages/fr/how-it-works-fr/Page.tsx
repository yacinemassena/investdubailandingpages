...
const processSteps = [
  ...
  },
  {
    ...
    description:
      "Parcourez des projets sélectionnés, chacun adossé à une villa spécifique dans un quartier haut de gamme de Dubaï. Vous voyez le bien, le plan de rénovation, le budget et le rendement cible avant d'investir.",
    icon: Search,
    details: [
      "Page projet détaillée par villa",
      "Prix d'acquisition, budget de rénovation, calendrier prévu",
      "Ventes comparables et rendement cible",
  ...
  },
  {
    ...
    description:
      "Choisissez un projet et investissez. Vous devenez actionnaire de la SPV qui détient la villa. Votre capital va vers un bien spécifique, pas dans un fonds commun.",
    icon: Wallet,
    details: [
      "Choisissez votre montant (minimum 1 000 $)",
      "Fonds alloués à un projet de villa spécifique",
      "Certificat d'actions émis",
      "Accès au tableau de bord activé",
    ],
  },
  {
    number: "04",
    ...
    description:
      "Suivez l'avancement via plusieurs canaux. Nous envoyons des mises à jour parce que nous voulons que vous voyiez le travail, pas parce que la réglementation l'exige.",
    icon: Eye,
    details: [
      "Groupe WhatsApp avec l'équipe projet",
      "Photos et vidéos hebdomadaires",
      "Jalons et suivi budgétaire sur le tableau de bord",
  ...
  },
  {
    ...
    description:
      "À la vente de la villa, le bilan final est préparé et votre capital plus les bénéfices sont crédités sur votre portefeuille. Généralement sous 2-4 semaines après la clôture.",
    icon: Banknote,
    details: [
      "Villa vendue au prix du marché",
      "Bilan final préparé",
      "Capital + bénéfices crédités sur votre portefeuille",
      "Retirez ou réinvestissez dans le prochain projet",
    ],
  },
];
