...
const processSteps = [
  {
    ...
    description:
      "Inscrivez-vous en ligne en quelques minutes et complétez la vérification d'identité (KYC). Les documents sont généralement vérifiés sous 24-48 heures. Aucun capital n'est engagé tant que vous n'avez pas choisi d'investir.",
    icon: UserPlus,
    details: [
      "Inscription en ligne simple",
      "Pièce d'identité + justificatif de domicile",
      "Approbation sous 24-48 heures",
      "Aucun capital engagé avant votre investissement",
    ],
  },
  {
    number: "02",
    ...
    description:
      "Accédez à une sélection de projets, chacun adossé à une villa spécifique dans des quartiers premium de Dubaï. Vous disposez de l’ensemble des informations : bien, plan de rénovation, budget et rendement cible avant d’investir.",
    icon: Search,
    details: [
      "Accès à une page projet détaillée",
      "Prix d'acquisition, budget de rénovation et calendrier prévisionnel",
      "Analyse des ventes comparables et rendement cible",
      "Documentation complète avant engagement",
    ],
  },
  {
    number: "03",
    title: "Investissez à partir de 1 000 €",
    description:
      "Sélectionnez un projet et investissez. Vous devenez actionnaire de la SPV qui détient le bien. Votre capital est directement investi dans un actif identifié, et non dans un fonds mutualisé.",
    icon: Wallet,
    details: [
      "Choix du montant d’investissement (minimum 1 000 €)",
      "Allocation des fonds à un projet spécifique",
      "Certificat d'actions émis",
      "Accès à votre tableau de bord",
    ],
  },
  {
    number: "04",
    title: "Suivez la Rénovation",
    description:
      "Suivez l’avancement du projet en temps réel via plusieurs canaux. Nous partageons des mises à jour régulières pour vous offrir une visibilité complète sur l’exécution.",
    icon: Eye,
    details: [
      "Accès à un groupe WhatsApp avec l’équipe projet",
      "Photos et vidéos hebdomadaires",
      "Suivi des jalons et du budget via le tableau de bord",
      "Notifications email aux étapes clés",
    ],
  },
  {
    number: "05",
    ...
    description:
      "À la vente du bien, un bilan de clôture est établi et votre capital ainsi que vos bénéfices sont crédités sur votre portefeuille. Les fonds sont généralement disponibles sous 2 à 4 semaines après la clôture.",
    icon: Banknote,
    details: [
      "Vente du bien au prix du marché",
      "Établissement du bilan de clôture",
      "Capital et bénéfices crédités sur votre portefeuille",
      "Possibilité de retirer ou de réinvestir dans un nouveau projet",
    ],
  },
];
...
const experienceFeatures = [
  {
    ...
    description:
      "Chaque opération dispose de son canal WhatsApp dédié. Recevez en temps réel les mises à jour de l’équipe projet : photos d’avancement, suivi du planning et réponses à vos questions.",
  ...
  },
  {
    ...
    description:
      "Suivez chaque étape de la rénovation, démolition, gros œuvre, finitions à travers nos reportages visuels hebdomadaires.\nUne transparence totale sur la transformation du bien.",
  ...
  },
  {
    ...
    description:
      "Chaque opération InvestDubai est exécutée par Greenbull Properties, notre pôle immobilier basé à Dubaï ayant déjà acquis, rénové et revendu plus de 40 villas de luxe. Nous intégrons nos propres architectes, chefs de projet et superviseurs de chantier pour un contrôle total de l'acquisition à la revente.\nVous investissez aux côtés de l’équipe qui exécute directement les opérations.",
  ...
  },
  {
    ...
    description:
      "Accédez à l’ensemble des informations liées à votre investissement : jalons de l’opération, suivi budgétaire, échéancier et documentation juridique et financière.\nTout est centralisé et accessible à tout moment.",
  ...
  },
  {
    ...
    description:
      "Recevez des rapports structurés à chaque étape clé de l’opération, de l’acquisition à la revente.\nVous êtes informé des avancées majeures, de la mise sur le marché jusqu’à la clôture de la vente.",
...
export const HowItWorksPage = () => {
  useDocumentHead({
    title: 'Comment Ça Marche | De l\'Inscription aux Gains | InvestDubai',
    description: 'De la création de compte à la distribution des bénéfices en 5 étapes. Découvrez comment les investisseurs InvestDubai accèdent aux villas de luxe à Dubaï en toute transparence.',
    canonical: 'https://www.investdubai.com/fr/how-it-works',
  });
        ...
        <div className="max-w-4xl mx-auto px-5 sm:px-6 lg:px-12 text-center relative z-10">
          ...
          >
            ...
            <h1 className="text-display-1 text-black mb-6">
              <span className="block">De l'inscription à la revente.</span>
              <span className="block">Une transparence totale.</span>
            </h1>
            <p className="text-body-lg text-gray-600 max-w-2xl mx-auto mb-10">
              Aucune zone d’ombre. Vous savez précisément comment votre capital est déployé, comment la valeur est créée et comment vos plus-values sont générées.
              <br />
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
          <div className="text-center mb-20">
            ...
            <p className="text-body-lg text-gray-600 max-w-2xl mx-auto">
              Nous prenons en charge l’intégralité du processus : recherche, rénovation et revente. Il vous suffit de sélectionner une opportunité, d’investir, de suivre l’avancement du projet et de percevoir vos plus-values.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-body-lg text-gray-400 mb-8">
                  Contrairement aux fonds immobiliers traditionnels, votre capital n’est jamais opaque.
                  <br />
                  Vous suivez chaque étape de l’opération, de l’acquisition à la revente.
                </p>
                <ul className="space-y-4">
                  {[
                    "Vous savez précisément où est investi votre capital",
                    "Vous suivez la rénovation en temps réel",
                    "Vous échangez directement avec l’équipe sur le terrain",
                    "Vous accédez à une documentation complète à chaque étape",
                  ].map((item, i) => (
