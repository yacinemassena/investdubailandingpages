...
export const WhatsAppMockup = () => {
  return (
    <div className="relative rounded-3xl overflow-hidden bg-[#EFEAE2] border-4 border-gray-800 shadow-2xl h-[420px] md:h-[500px] w-[236px] md:w-[281px] flex flex-col font-sans mx-auto">
      {/* Status Bar Mock */}
      ...
      <div className="bg-[#075E54] text-white p-3 flex items-center justify-between shadow-md z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-body leading-tight">Villa Jumeirah Islands - Mises à jour</h3>
            <p className="text-body text-white/70">Vous, Sarah, Alex, +4 autres</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')] bg-cover bg-center">
        ...
        <div className="flex flex-col items-start max-w-[85%]">
          <div className="bg-white rounded-lg rounded-tl-none p-2 shadow-sm text-body text-gray-800">
            <span className="text-[#075E54] font-semibold text-body mb-1 block">Équipe InvestDubai</span>
            ...
            Bonjour à tous ! 🔨 La démolition est terminée et le nouveau plan commence à prendre forme. L'équipe travaille actuellement sur la plomberie.
        ...
        <div className="flex flex-col items-end w-full">
          <div className="bg-[#DCF8C6] rounded-lg rounded-tr-none p-2 shadow-sm text-body text-gray-800 max-w-[85%]">
            Superbe ! Merci pour la mise à jour. Quand la pose du sol commence-t-elle ?
        ...
        <div className="flex flex-col items-start max-w-[85%]">
          <div className="bg-white rounded-lg rounded-tl-none p-2 shadow-sm text-body text-gray-800">
            <span className="text-[#075E54] font-semibold text-body mb-1 block">Équipe InvestDubai</span>
            Les matériaux arrivent mardi prochain, et la pose commence mercredi ! 🚀
