          ...
          {selectedNeighborhood?.active && neighborhoodPriceData[selectedNeighborhood.id] ? (() => {
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <span className="text-zinc-500 text-body font-medium">Latest Price ({metrics.latest.quarter})</span>
                  </div>
                  <div className="text-stat text-zinc-100 mb-0.5">AED {metrics.latest.price.toLocaleString()}</div>
                  {metrics.yoyPercent && <div className="text-body font-medium text-emerald-400">+{metrics.yoyPercent}% YoY</div>}
                </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <span className="text-zinc-500 text-body font-medium">5-Year Growth</span>
                  </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <span className="text-zinc-500 text-body font-medium">Peak Price</span>
                  </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 md:p-6">
                <h3 className="text-body font-medium text-zinc-100 mb-4 md:mb-6">Quarterly Price Trends (AED per sqft)</h3>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <h3 className="text-body font-medium text-zinc-100 mb-6">Historical Data</h3>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-zinc-800">
                        <th className="text-center py-3 px-2 md:px-4 text-body font-medium text-zinc-500 uppercase tracking-wider">Quarter</th>
                        <th className="text-center py-3 px-2 md:px-4 text-body font-medium text-zinc-500 uppercase tracking-wider">Price (AED/sqft)</th>
                        <th className="text-center py-3 px-2 md:px-4 text-body font-medium text-zinc-500 uppercase tracking-wider">QoQ Change</th>
                        <th className="text-center py-3 px-2 md:px-4 text-body font-medium text-zinc-500 uppercase tracking-wider">YoY Change</th>
                      </tr>
                    </thead>
                    <tbody>
                      {priceData.slice().reverse().map((data, i, arr) => {
                        ...
                        return (
                          <tr key={data.quarter} className="border-b border-zinc-800/50 hover:bg-zinc-800/50 transition-colors">
                            <td className="py-3 px-2 md:px-4 text-center text-zinc-300 text-body font-medium">{data.quarter}</td>
                            <td className="py-3 px-2 md:px-4 text-center text-zinc-200 text-body tabular-nums">{data.price.toLocaleString()}</td>
                            <td className={`py-3 px-2 md:px-4 text-center text-body font-medium ${
