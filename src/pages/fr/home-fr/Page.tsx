        ...
        <section className="py-12 md:py-20 bg-[#0D0D0D] text-white overflow-hidden">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="text-center max-w-4xl mx-auto mb-10 md:mb-16">
              <motion.span variants={fadeUp} className="inline-block px-4 py-1.5 bg-brand-accent/10 text-brand-accent text-label rounded-full mb-6 border border-brand-accent/20">NOS OPÉRATIONS</motion.span>
              <motion.h2 variants={fadeUp} className="text-h2 text-white mb-4 md:mb-6">
                Bientôt 50 villas rénovées et revendues.
              </motion.h2>
              <motion.p variants={fadeUp} className="text-body-lg text-gray-400 px-2 sm:px-0">
                Chaque opération suit le même modèle : identifier des biens sous-évalués dans les quartiers les plus recherchés, les rénover selon les standards du marché de l'ultra-luxe et les revendre au meilleur prix.
                Voici un aperçu de nos dernières opérations.
              </motion.p>
            </motion.div>
          </div>
