  ...
  content: {
    en: {
      ...
      trust: {
        ...
        items: [
          { icon: "shield", title: "Is this legitimate?", description: "Yes. You own equity in a legal entity (SPV) that holds real property. DIFC regulated. $327M deployed. 40+ completed projects.\n\n2,500+ investors. Greenbull Group valued at €230M with 10+ years of track record. This is real." },
          { icon: "history", title: "What returns are realistic?", description: "Historical average: ~20% per project over 12-18 months. Range: 15-52% depending on the project.\n\nPast performance doesn't guarantee future results, but our process is proven across 40+ projects. We show you the full range, not just the winners." },
          { icon: "clock", title: "How long is money locked?", description: "Typically 6-18 months per project. No early exit option currently.\n\nMake sure you're comfortable with the full potential timeline before investing. This is illiquid capital." }
        ]
      },
      faq: {
