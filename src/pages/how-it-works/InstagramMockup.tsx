...
export const InstagramMockup = () => {
  ...
  return (
    <div ref={containerRef} className="relative rounded-3xl overflow-hidden bg-black border-4 border-gray-800 shadow-2xl h-[420px] md:h-[500px] w-[236px] md:w-[281px] mx-auto flex flex-col font-sans group">
      ...
      <div className="relative flex-1 bg-gray-900">
        ...
        <div className="absolute top-0 inset-x-0 p-4 z-30">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="text-white font-semibold text-body shadow-sm">investdubai</span>
                <span className="text-white/80 text-body ml-2">{stories[currentStory].time}</span>
              </div>
            </div>
        ...
        <div className="absolute bottom-0 inset-x-0 p-4 flex items-center gap-4 z-30">
          <div className="flex-1 bg-transparent border border-white/40 rounded-full px-3 py-2 text-white/80 text-xs">
            Send message
          </div>
