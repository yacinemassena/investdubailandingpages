    ...
    <section className="py-12 md:py-20 bg-brand-surface">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
          ...
          <div className="bg-gray-100 rounded-3xl p-8 md:p-10 border border-gray-200">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-h3 text-brand-dark">This may not fit if you...</h3>
            </div>
            <ul className="space-y-4">
        ...
        <div className="text-center">
          <p className="text-body-lg text-brand-dark mb-8 max-w-2xl mx-auto">
