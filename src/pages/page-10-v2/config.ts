  ...
  content: {
    en: {
      ...
      trust: {
        ...
        items: [
          { icon: "shield", title: "Is this legitimate?", description: "Yes. You own equity in a legal entity (SPV) that holds real property. DIFC regulated. $327M deployed. 50+ completed projects. 2,500+ investors. Greenbull Group valued at €230M with 10+ years of track record. This is real." },
          { icon: "history", title: "What returns are realistic?", description: "Historical average: ~20% per project over 12–18 months. Range: 15–52% depending on the project. Past performance doesn't guarantee future results, but our process is proven across 50+ projects. We show you the full range—not just the winners." },
    ...
    fr: {
      ...
      trust: {
        ...
        items: [
          { icon: "shield", title: "C'est Légitime ?", description: "Oui. Vous détenez des parts dans une entité légale (SPV) qui possède un bien réel. Régulation DIFC. 327M$ déployés. 50+ projets complétés. 2 500+ investisseurs. Greenbull Group valorisé à 230M€ avec 10+ ans d'historique. C'est réel." },
          { icon: "history", title: "Quels rendements sont réalistes ?", description: "Moyenne historique : ~20% par projet sur 12 à 18 mois. Fourchette : 15 à 52% selon le projet. Les performances passées ne garantissent pas les résultats futurs, mais notre processus est éprouvé sur 50+ projets. Nous vous montrons toute la gamme—pas juste les gagnants." },
