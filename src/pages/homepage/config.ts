export const homepageConfig = {
  ...
  hero: {
    en: {
      ...
      trustBadges: [
        ...
        '12–18 month cycles',
        '100% remote',
        '$130M+ verified profits',
      ],
    },
    fr: {
      headline: 'Surpassez les Placements Traditionnels — Avec l\'Immobilier de Luxe à Dubai',
      subheadline: 'Visez 20%+ de rendement annuel sur des cycles de 12 à 18 mois. On achète, on rénove, on revend des villas de luxe — vous investissez et partagez la plus-value.',
      proofLine: 'Track record : 70% de ROI moyen sur 36 projets finalisés. Plus de $130M de profits générés.',
      primaryCta: 'Commencer',
      secondaryCta: 'Voir le Track Record ↓',
      trustBadges: [
        'SPV régulée DIFC',
        'Cycles 12–18 mois',
        '100% à distance',
        '$130M+ de profits vérifiés',
      ],
    },
  },
  ...
  problem: {
    en: {
      ...
      comparison: [
        ...
        { investment: 'Buy-to-Let', returns: '4–6% net', timeline: 'Forever', catch: 'Tenant headaches. Illiquid capital.' },
    ...
    fr: {
      ...
      comparison: [
        ...
        { investment: 'Stock picking', returns: 'Variable', timeline: 'Variable', catch: 'Expertise requise. Volatilité élevée.' },
        { investment: 'Locatif classique', returns: '4–6% net', timeline: 'Infini', catch: 'Gestion locataire. Capital bloqué.' },
        { investment: 'Off-Plan Dubai', returns: 'Incertain', timeline: '3–5 ans', catch: 'Attente longue. Pas de création de valeur.' },
        { investment: 'Flips Luxe Dubai', returns: 'Objectif 20%+', timeline: '12–18 mois', catch: 'Clé en main. Capital libéré à la revente.', highlight: true },
      ],
  ...
  trackRecord: {
    en: {
      ...
      stats: [
        ...
        { value: '$130M+', label: 'Profits Delivered' },
    ...
    fr: {
      ...
      stats: [
        ...
        { value: '36', label: 'Flips Finalisés' },
        { value: '$130M+', label: 'Profits Générés' },
        { value: '70%', label: 'ROI Moyen' },
        { value: '0', label: 'Rendements Négatifs' },
      ],
      projects: [
        { name: 'Flip 1', investment: '6,85M AED', salePrice: '14,2M AED', roi: '107%' },
      ...
      pillars: [
        {
          ...
          badges: ['Régulé DIFC', 'Titre de propriété à votre nom', 'Garantie réelle sur l\'actif'],
        },
        {
          icon: 'shield',
          ...
          badges: ['Engagement fixe', 'Pas de surprise', 'On prend le risque d\'exécution'],
        },
        {
          icon: 'dollar',
          ...
          badges: ['15% rendement prioritaire', 'L\'investisseur d\'abord', 'Intérêts alignés'],
        },
      ],
      summary: [
        { protection: 'SPV régulée DIFC', meaning: 'Propriété réelle, garantie réelle' },
  ...
  whyUs: {
    ...
    fr: {
      ...
      extras: [
        ...
        'Base d\'investisseurs mondiale — Europe, Asie, Moyen-Orient et au-delà',
      ],
    },
  },
  ...
  whoIsItFor: {
    ...
    fr: {
      ...
      yesIf: [
        ...
        'Vous voulez de l\'exposition immobilière sans gestion locative',
        'Vous acceptez le risque pour un potentiel de gain supérieur',
        'Vous avez du capital disponible pour 12–18 mois',
      ],
      noIf: [
    ...
    en: {
      ...
      items: [
        ...
        { 
          ...
          answer: 'The preferred return is a protection mechanism that ensures you get paid first. Here\'s how it works: You receive a 15% annualized return on your investment before we take any profit share. Only after you\'ve received this priority return do we participate in the remaining upside (60% to you, 40% to us). This means if a project only generates 15% returns, we get nothing from profit share. We only profit significantly when you profit well. This structure aligns our incentives with yours.' 
        },
        { 
    ...
    fr: {
      ...
      items: [
        { 
          ...
          answer: 'Vous investissez dans une villa de luxe spécifique à Dubai — un bien réel et physique que vous pourriez visiter. Chaque villa est détenue par une SPV dédiée (Special Purpose Vehicle), une entité légale créée uniquement pour posséder ce bien. Vous achetez des parts dans la SPV, ce qui fait de vous un co-propriétaire de la villa aux côtés d\'autres investisseurs. Votre nom apparaît sur les documents de propriété légaux. C\'est de la vraie propriété — pas un prêt, pas un token, pas une part de fonds. Vous possédez un morceau d\'immobilier réel à Dubai.' 
        },
        { 
          question: 'Comment les rendements sont-ils générés ?', 
          answer: 'Nous suivons une stratégie à valeur ajoutée appelée "flipping". Voici comment ça marche : D\'abord, nous identifions des villas de luxe sous-évaluées dans les meilleurs quartiers de Dubai — typiquement des propriétés démodées ou mal entretenues mais dans d\'excellents emplacements. Nous les achetons 30-40% en dessous du prix des propriétés rénovées comparables. Ensuite, notre équipe interne exécute une rénovation luxe complète : nouveaux intérieurs, finitions premium, agencements modernes. Enfin, nous vendons la villa transformée au prix du marché pour les propriétés rénovées. La différence entre notre coût total (achat + rénovation) et le prix de vente est le profit — et vous recevez 60% de ce profit, proportionnellement à votre investissement.' 
        },
        { 
          question: 'Quels rendements puis-je attendre ?', 
          answer: 'Nous visons 20%+ de rendement annuel sur chaque projet. Notre historique montre une moyenne de 70% de ROI total par projet sur des cycles de 12-18 mois. Les projets individuels ont varié de 15% à plus de 100% selon l\'opportunité spécifique. Important : les performances passées ne garantissent pas les résultats futurs. Les marchés immobiliers fluctuent, et chaque projet comporte ses propres risques. Nous vous montrons toute la gamme des résultats — pas seulement les gagnants — pour que vous puissiez prendre une décision éclairée.' 
        },
        { 
          question: 'Comment mon investissement est-il protégé ?', 
          answer: 'Trois niveaux de protection : (1) Propriété SPV — Votre investissement est détenu dans une entité légale séparée qui possède le bien directement. Même si quelque chose arrivait à Greenbull, la SPV possède toujours la villa et votre participation reste intacte. (2) Régulation DIFC — Nous opérons sous la juridiction du Dubai International Financial Centre, qui suit le droit anglais — l\'un des cadres les plus solides au monde pour la protection des investisseurs. (3) Zéro Dette — Nous utilisons 100% de fonds propres pour les acquisitions. Pas de prêts bancaires signifie pas de risque de saisie, pas d\'exposition aux taux d\'intérêt, et pas de scénarios de liquidation forcée.' 
        },
        { 
          question: 'Qu\'est-ce que le rendement prioritaire de 15% ?', 
          answer: 'Le rendement prioritaire est un mécanisme de protection qui garantit que vous êtes payé en premier. Voici comment ça marche : Vous recevez un rendement annualisé de 15% sur votre investissement avant que nous ne prenions notre part de profit. Ce n\'est qu\'après avoir reçu ce retour prioritaire que nous participons au reste (60% pour vous, 40% pour nous). Cela signifie que si un projet ne génère que 15% de rendement, nous n\'obtenons rien du partage de profit. Nous ne profitons significativement que quand vous profitez bien. Cette structure aligne nos intérêts avec les vôtres.' 
        },
        { 
          question: 'Que se passe-t-il si les coûts de rénovation dépassent le budget ?', 
          answer: 'Nous garantissons le budget de rénovation. Quand vous investissez, le coût de rénovation est fixé dès le départ. Si notre équipe rencontre des dépenses imprévues — augmentation des prix des matériaux, travaux structurels inattendus, dépassements de coûts de main-d\'œuvre — nous absorbons ces coûts, pas vous. Votre exposition en capital est plafonnée à votre investissement initial. Nous ne vous demanderons jamais de fonds supplémentaires. C\'est possible parce que nous contrôlons tout le processus de rénovation en interne, ce qui nous donne des estimations de coûts précises et un contrôle de l\'exécution.' 
        },
        { 
          question: 'Puis-je investir à distance depuis un autre pays ?', 
          answer: 'Absolument — 100% du processus est digital. Vous pouvez investir de n\'importe où dans le monde. Nos investisseurs viennent de 20+ pays à travers l\'Europe, l\'Asie, le Moyen-Orient et au-delà. Le processus : créez votre compte en ligne, complétez la vérification KYC digitale (24-48 heures), alimentez votre wallet par virement ou carte, sélectionnez un projet, et investissez. Vous recevrez des mises à jour hebdomadaires via votre tableau de bord, stories Instagram et documentation YouTube. La plupart de nos 2 500+ investisseurs n\'ont jamais mis les pieds à Dubai.' 
        },
        { 
          question: 'Quel est l\'investissement minimum et comment monter en puissance ?', 
          answer: 'L\'investissement minimum est de 4 000 AED (environ 1 100$ USD ou 1 000€). Ce ticket d\'entrée accessible vous permet de tester le modèle avec un risque limité. Beaucoup d\'investisseurs commencent avec une petite position, suivent le projet via les mises à jour hebdomadaires, puis montent en puissance sur les projets suivants une fois qu\'ils ont vu le processus de leurs propres yeux. Certains investisseurs qui ont commencé au minimum déploient maintenant 50 000€+ par projet. Vous pouvez diversifier sur plusieurs projets ou concentrer — c\'est votre choix.' 
        },
        { 
          question: 'Combien de temps mon argent est-il bloqué et puis-je sortir plus tôt ?', 
          answer: 'La durée typique d\'un projet est de 12-18 mois, couvrant l\'acquisition, la rénovation, le marketing et la vente. Actuellement, il n\'y a pas de mécanisme de sortie anticipée — une fois investi, votre capital est engagé jusqu\'à la vente du bien. C\'est du capital illiquide, donc n\'investissez que l\'argent dont vous n\'aurez pas besoin pendant la durée du projet. Quand la villa est vendue, les fonds sont distribués sur votre wallet sous 2-4 semaines. Vous pouvez ensuite retirer vers votre banque ou réinvestir dans de nouveaux projets.' 
        },
        { 
          question: 'Quels sont les risques et comment les atténuez-vous ?', 
          answer: 'L\'investissement immobilier comporte de vrais risques : (1) Risque de Marché — Les valeurs immobilières à Dubai pourraient baisser, réduisant les prix de vente. Nous atténuons cela en achetant 30-40% sous la valeur rénovée, créant une marge de sécurité. (2) Risque d\'Exécution — Les rénovations pourraient subir des retards ou complications. Nous atténuons cela avec notre équipe interne et 50+ projets complétés d\'expérience. (3) Risque de Liquidité — Votre capital est bloqué 12-18 mois sans sortie anticipée. (4) Risque de Change — Les investissements sont en AED (indexé sur l\'USD) ; les investisseurs EUR font face aux fluctuations de taux de change. Nous ne pouvons pas éliminer ces risques — nous pouvons seulement ingénier des marges pour les absorber. Investissez en conséquence.' 
        },
      ],
    },
  },
  ...
  finalCta: {
    ...
    fr: {
      ...
      reassurance: 'Des questions ? Notre équipe est là pour vous aider. Réservez un appel gratuit à tout moment.',
    },
  },

  footer: {
    copyright: '© 2026 InvestDubai · Powered by Greenbull Group',
    links: [
