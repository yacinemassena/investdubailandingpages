      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12 relative z-10">
          ...
          <div className="flex items-center gap-4 md:gap-8 overflow-x-auto no-scrollbar pb-4">
            {CATEGORIES.map((cat) => (
              <button
                ...
                className={`text-body transition-all whitespace-nowrap tracking-wide ${
              ...
              <div key={section.id} className="scroll-mt-32" id={section.id}>
                <div className="flex items-center justify-between mb-8 md:mb-12">
                  ...
                  <button 
                    ...
                    className="text-body text-white/40 hover:text-brand-accent transition-colors flex items-center gap-2 whitespace-nowrap"
                  >
        ...
        <div className="mt-16 md:mt-32 pt-16 md:pt-32 border-t border-white/10 text-center relative">
          ...
          <a 
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-3 md:gap-4 px-6 md:px-10 py-4 md:py-5 bg-white text-brand-dark rounded-full font-medium text-body-lg hover:bg-brand-accent hover:text-white transition-all transform hover:scale-105 shadow-xl hover:shadow-brand-accent/20"
          >
            START NOW
            <ArrowRight size={20} />
          </a>
