...
Standardized villa types

Deep value-add margins (often targeting large gap spreads)
...
Create account (digital onboarding)
...
Invest once project opens

SPV formed

Title deed issued to SPV

Renovation phase

Resale

Capital + profit credited to wallet
...
Plan de communication sur 45 jo…
...
Trust (legal + transparency + team credibility)
...
Traditional Crowdfunding	InvestDubai
Debt-based	Equity SPV ownership
Opaque updates	Weekly visible updates
Blind pool	Specific villa projects
Often leveraged	100% cash
Passive sponsor	Active operator
Low visibility	Founder-driven transparency
