...
export const trackRecordProjects: TrackRecordProject[] = [
  ...
  { id: 4, name: 'Flip 4', status: 'Hold', totalInvestment: 'AED 23,700,000', sellingPrice: 'AED 60,000,000', roi: '153%', image: `${R2_BASE}/Flip_04_Hold.jpg` },
  { id: 5, name: 'Flip 5', status: 'Hold', totalInvestment: 'AED 14,656,000', sellingPrice: 'AED 35,000,000', roi: '139%', image: `${R2_BASE}/Flip_05_Hold.jpg` },
  { id: 6, name: 'Flip 6', status: 'Hold', totalInvestment: 'AED 15,092,000', sellingPrice: 'AED 37,000,000', roi: '139%', image: `${R2_BASE}/Flip_06_Hold.jpg` },
  ...
  { id: 23, name: 'Flip 23', status: 'Hold', totalInvestment: 'AED 14,182,000', sellingPrice: 'AED 27,000,000', roi: '76%', image: `${R2_BASE}/Flip_23_Hold.jpg` },
  ...
  { id: 36, name: 'Flip 36', status: 'Sold', totalInvestment: 'AED 30,500,000', sellingPrice: 'AED 45,000,000', roi: '64%', image: `${R2_BASE}/Flip_36_Sold.jpg` },
  { id: 37, name: 'Flip 37', status: 'In-Progress', totalInvestment: '—', sellingPrice: '—', roi: '—', image: `${R2_BASE}/Flip_37_In-Progress.jpg` },
  { id: 38, name: 'Flip 38', status: 'In-Progress', totalInvestment: '—', sellingPrice: '—', roi: '—', image: `${R2_BASE}/Flip_38_In-Progress.jpg` },
  { id: 39, name: 'Flip 39', status: 'In-Progress', totalInvestment: '—', sellingPrice: '—', roi: '—', image: `${R2_BASE}/Flip_39_In-Progress.jpg` },
  { id: 40, name: 'Flip 40', status: 'In-Progress', totalInvestment: '—', sellingPrice: '—', roi: '—', image: `${R2_BASE}/Flip_40_In-Progress.jpg` },
];
...
export const getStatusColor = (status: TrackRecordProject['status']) => {
  switch (status) {
    ...
    case 'Hold':
      return { bg: 'bg-amber-500', dot: 'bg-amber-500', text: 'text-white' };
    case 'In-Progress':
