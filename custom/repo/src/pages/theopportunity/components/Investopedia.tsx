...
export function Investopedia() {
  ...
  return (
    <section id="investopedia" className="py-16 md:py-32 bg-brand-dark text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8">
          <div className="max-w-2xl">
            ...
            <h2 className="text-3xl md:text-6xl lg:text-7xl font-serif mb-4 md:mb-6 leading-[1.1]">
              The future of Dubai real estate: <br className="hidden md:block" />
              <span className="italic text-white/60">Trends & insights</span>
            </h2>
            <p className="text-brand-muted text-base md:text-xl max-w-xl">
            ...
            <div className="lg:col-span-2 group">
              <Link to={`/investopedia/${mainFeatured.slug}`} className="block">
                ...
                <div className="space-y-4">
                  ...
                  <h3 className="text-2xl md:text-4xl font-serif leading-tight group-hover:text-brand-accent transition-colors">
                    {mainFeatured.title}
                  </h3>
                  <p className="text-white/60 text-base md:text-lg line-clamp-2 max-w-2xl">
            ...
            {sections.map((section) => (
              <div key={section.id} className="scroll-mt-32" id={section.id}>
                <div className="flex items-center justify-between mb-8 md:mb-12">
                  <h3 className="text-xl md:text-4xl font-serif">{section.label}</h3>
                  ...
                  {section.articles.map((article) => (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        ...
                        <h4 className="text-base md:text-xl font-medium leading-tight group-hover:text-brand-accent transition-colors line-clamp-2">
                          {article.title}
                        </h4>
        ...
        <div className="mt-16 md:mt-32 pt-16 md:pt-32 border-t border-white/10 text-center relative">
          ...
          <h2 className="text-3xl md:text-7xl font-serif mb-8 md:mb-12">
            Start your investment <br />
            <span className="italic text-white/40 text-2xl md:text-6xl">journey in 10 minutes today</span>
          </h2>
          <Link 
            to="/" 
            className="inline-flex items-center gap-3 md:gap-4 px-6 md:px-10 py-4 md:py-5 bg-white text-brand-dark rounded-full font-bold text-base md:text-lg hover:bg-brand-accent hover:text-white transition-all transform hover:scale-105 shadow-xl hover:shadow-brand-accent/20"
          >
            START NOW
            <ArrowRight size={20} />
          </Link>
