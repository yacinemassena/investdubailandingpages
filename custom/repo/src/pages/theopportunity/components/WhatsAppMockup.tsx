...
export const WhatsAppMockup = () => {
  return (
    <div className="relative rounded-3xl overflow-hidden bg-[#EFEAE2] border-4 border-gray-800 shadow-2xl aspect-[4/3] md:aspect-auto md:h-[400px] flex flex-col font-sans max-w-sm mx-auto">
      {/* Status Bar Mock */}
      <div className="bg-[#075E54] w-full h-6 flex justify-between items-center px-4 text-white/90 text-xs">
        <span>09:41</span>
      ...
      <div className="bg-[#075E54] text-white p-3 flex items-center justify-between shadow-md z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-sm leading-tight">Palm Jumeirah Villa - Updates</h3>
            <p className="text-xs text-white/70">You, Sarah, Alex, +4 others</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')] bg-cover bg-center">
        ...
        <div className="flex flex-col items-start max-w-[85%]">
          <div className="bg-white rounded-lg rounded-tl-none p-2 shadow-sm text-sm text-gray-800">
            <span className="text-[#075E54] font-semibold text-xs mb-1 block">InvestDubai Team</span>
            ...
            <div className="text-[10px] text-gray-400 text-right mt-1">10:30</div>
          </div>
        </div>

        {/* Message from Investor */}
        <div className="flex flex-col items-end w-full">
          <div className="bg-[#DCF8C6] rounded-lg rounded-tr-none p-2 shadow-sm text-sm text-gray-800 max-w-[85%]">
            Looks amazing! Thanks for the update. When does the flooring start?
            <div className="flex items-center justify-end gap-1 mt-1">
              <span className="text-[10px] text-gray-500">11:15</span>
        ...
        <div className="flex flex-col items-start max-w-[85%]">
          <div className="bg-white rounded-lg rounded-tl-none p-2 shadow-sm text-sm text-gray-800">
            ...
            <div className="text-[10px] text-gray-400 text-right mt-1">11:20</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#F0F0F0] p-2 flex items-center gap-2">
        <div className="bg-white flex-1 rounded-full px-4 py-2 flex items-center justify-between text-gray-400 text-sm">
          <span>Message</span>
