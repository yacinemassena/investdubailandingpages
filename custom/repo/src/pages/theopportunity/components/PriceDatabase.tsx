      ...
      <section className="py-10 border-b border-zinc-800/80">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="mb-10 flex flex-col items-center">
            <p className="text-[11px] font-medium uppercase tracking-widest text-zinc-500 mb-4">Category</p>
          ...
          {/* Neighborhood Grid */}
          <div>
            <p className="text-[11px] font-medium uppercase tracking-widest text-zinc-500 mb-4 text-center">Neighborhood</p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="flex flex-col items-center text-center mb-10">
            ...
            <span className="inline-block px-3 py-1 bg-zinc-800 text-zinc-400 text-xs font-medium rounded-md border border-zinc-700 mb-3">
          ...
          {selectedNeighborhood?.active && neighborhoodPriceData[selectedNeighborhood.id] ? (() => {
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <span className="text-zinc-500 text-xs font-medium">Latest Price ({metrics.latest.quarter})</span>
                  </div>
                  <div className="text-2xl font-semibold text-zinc-100 mb-0.5">AED {metrics.latest.price.toLocaleString()}</div>
                  {metrics.yoyPercent && <div className="text-xs font-medium text-emerald-400">+{metrics.yoyPercent}% YoY</div>}
                </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <span className="text-zinc-500 text-xs font-medium">5-Year Growth</span>
                  </div>
                  <div className="text-2xl font-semibold text-zinc-100 mb-0.5">+{metrics.growthPercent}%</div>
                  <div className="text-xs text-zinc-500">Since {metrics.first.quarter}</div>
                </div>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
                  <div className="flex items-center gap-2.5 mb-3">
                    ...
                    <span className="text-zinc-500 text-xs font-medium">Peak Price</span>
                  </div>
                  <div className="text-2xl font-semibold text-zinc-100 mb-0.5">AED {metrics.peak.price.toLocaleString()}</div>
                  <div className="text-xs text-zinc-500">{metrics.peak.quarter}</div>
                </div>
              </div>

              {/* Price Chart */}
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <h3 className="text-sm font-medium text-zinc-100 mb-6">Quarterly Price Trends (AED per sqft)</h3>
                <div className="relative h-80 group">
                    ...
                    {priceData.map((d, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                            <div className="text-xs text-zinc-400">{d.quarter}</div>
                            <div className="text-sm font-semibold text-white">AED {d.price.toLocaleString()}</div>
                          </div>
                        </div>
                      );
                    })}
                  ...
                  {/* Y-axis labels */}
                  <div className="absolute left-0 top-0 h-full flex flex-col justify-between text-[11px] text-zinc-600 -ml-12">
                ...
                {/* X-axis labels */}
                <div className="flex justify-between mt-4 text-[11px] text-zinc-600">
              ...
              {/* Data Table */}
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                <h3 className="text-sm font-medium text-zinc-100 mb-6">Historical Data</h3>
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-zinc-800">
                        <th className="text-center py-3 px-2 md:px-4 text-xs font-medium text-zinc-500 uppercase tracking-wider">Quarter</th>
                        <th className="text-center py-3 px-2 md:px-4 text-xs font-medium text-zinc-500 uppercase tracking-wider">Price (AED/sqft)</th>
                        <th className="text-center py-3 px-2 md:px-4 text-xs font-medium text-zinc-500 uppercase tracking-wider">QoQ Change</th>
                        <th className="text-center py-3 px-2 md:px-4 text-xs font-medium text-zinc-500 uppercase tracking-wider">YoY Change</th>
                      </tr>
                    </thead>
                    <tbody>
                      {priceData.slice().reverse().map((data, i, arr) => {
                        ...
                        return (
                          <tr key={data.quarter} className="border-b border-zinc-800/50 hover:bg-zinc-800/50 transition-colors">
                            <td className="py-3 px-2 md:px-4 text-center text-zinc-300 text-sm font-medium">{data.quarter}</td>
                            <td className="py-3 px-2 md:px-4 text-center text-zinc-200 text-sm tabular-nums">{data.price.toLocaleString()}</td>
                            <td className={`py-3 px-2 md:px-4 text-center text-sm font-medium ${
