    ...
    <section id="how-it-works" className="py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-12">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={staggerContainer} className="flex flex-col sm:flex-row items-center justify-center gap-3 md:gap-4">
          ...
          <motion.a variants={fadeUp} href="/how-it-works" className="w-full sm:w-auto border border-brand-border bg-brand-surface text-brand-dark px-6 md:px-8 py-3.5 md:py-4 rounded-full font-medium inline-flex items-center justify-center gap-2 text-sm md:text-base hover:bg-brand-bg transition-colors">
            See Full Process
            <ArrowRight className="w-4 h-4" />
          </motion.a>
        </motion.div>
