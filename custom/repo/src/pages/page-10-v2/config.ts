...
export const pageConfig: PageConfig = {
  ...
  content: {
    en: {
      ...
      answerCapsule: "You have questions. You should. This is your money. This comprehensive FAQ covers everything investors ask before committing capital: security and ownership, returns and fees, timeline and liquidity, market risks, and support options. No vague answers, no marketing fluff, no fine print buried at the bottom. Just honest information you need to invest with confidence—or decide this isn't for you. Either way, you'll know.",
      ...
      howItWorks: {
        ...
        subtitle: "Jump directly to the topics that matter most to you. Find your answers fast.",
        transitionBridge: "We've organized 30+ questions into categories so you can find exactly what you need. No searching through walls of text. Here's what's covered.",
        steps: [
          { title: "Security & ownership: is your money safe?", description: "SPV structure, title deeds, DIFC regulation, what happens if something goes wrong, asset protection. The questions everyone asks first." },
          { title: "Returns & fees: what you'll Actually Make", description: "Expected returns, profit sharing mechanics, fee transparency, priority returns, historical performance. The numbers that matter." },
          { title: "Timeline & liquidity: when you get your money back", description: "How long investments last, what affects duration, when you get paid, early exit options. The timeline questions." },
          { title: "Market & risk: what could go wrong", description: "Dubai market dynamics, what could go wrong, how risks are mitigated, worst-case scenarios. The honest risk assessment." },
          { title: "Process & support: how this actually works", description: "How to sign up, KYC requirements, funding options, ongoing communication, getting help. The practical logistics." },
          { title: "Getting started: your first investment", description: "Minimum investment, first steps, what to expect, scaling up over time. The beginner questions." }
        ]
      },
      trust: {
        title: "Top questions from new investors",
        items: [
          { icon: "shield", title: "Is this legitimate?", description: "Yes. You own equity in a legal entity (SPV) that holds real property. DIFC regulated. $327M deployed. 40+ completed projects. 2,500+ investors. Greenbull Group valued at €230M with 10+ years of track record. This is real." },
          { icon: "history", title: "What returns are realistic?", description: "Historical average: ~20% per project over 12–18 months. Range: 15–52% depending on the project. Past performance doesn't guarantee future results, but our process is proven across 40+ projects. We show you the full range—not just the winners." },
          { icon: "clock", title: "How long is money locked?", description: "Typically 6–18 months per project. No early exit option currently. Make sure you're comfortable with the full potential timeline before investing. This is illiquid capital." }
        ]
      },
      faq: {
        ...
        items: [
          ...
          // Getting Started
          { question: "What is the minimum investment?", answer: "Minimum investment is approximately 4,000 AED. This low threshold allows you to start small, learn the model, and scale up as you gain confidence." },
      ...
      nextStep: {
        title: "Still have questions? book a call. ready to start? create your account.",
        subtitle: "Join 2,500+ investors in 40+ countries. If you need more clarity, book a call with our team. If you're ready, create your account and explore projects. Either way, you're in control.",
        primaryCta: "Create Your Free Account",
    ...
    fr: {
      badge: "FAQ Complète",
      headline: "Toutes Vos Questions Avant d'Investir. Répondues Honnêtement. Zéro Bullshit.",
      answerCapsule: "Vous avez des questions. C'est normal. C'est votre argent. Cette FAQ complète couvre tout ce que les investisseurs demandent avant d'engager du capital : sécurité et propriété, rendements et frais, timeline et liquidité, risques de marché, et options de support. Pas de réponses vagues, pas de blabla marketing, pas de petits caractères cachés en bas. Juste l'information honnête dont vous avez besoin pour investir en confiance—ou décider que ce n'est pas pour vous. Dans tous les cas, vous saurez.",
      ...
      howItWorks: {
        ...
        subtitle: "Allez directement aux sujets qui vous intéressent. Trouvez vos réponses rapidement.",
        transitionBridge: "Nous avons organisé 30+ questions en catégories pour que vous trouviez exactement ce dont vous avez besoin. Pas de recherche dans des murs de texte. Voici ce qui est couvert.",
        steps: [
          { title: "Sécurité & propriété : votre argent est-il en sécurité ?", description: "Structure SPV, actes de propriété, régulation DIFC, protection des actifs. Les questions que tout le monde pose en premier." },
          { title: "Rendements & frais : ce que vous gagnerez réellement", description: "Rendements attendus, mécanique de partage, transparence des frais. Les chiffres qui comptent." },
          { title: "Timeline & liquidité : quand vous récupérez votre argent", description: "Durée des investissements, facteurs d'influence, quand vous êtes payé. Les questions de timeline." },
          { title: "Marché & risques : ce qui pourrait mal tourner", description: "Dynamiques du marché Dubai, ce qui pourrait mal tourner, atténuation des risques. L'évaluation honnête des risques." },
          { title: "Processus & support : comment ça marche vraiment", description: "Comment s'inscrire, exigences KYC, options de financement, communication. La logistique pratique." },
          { title: "Démarrer : votre premier investissement", description: "Investissement minimum, premières étapes, quoi attendre, monter en puissance. Les questions de débutants." }
        ]
      },
      trust: {
        title: "Top questions des nouveaux investisseurs",
        items: [
          { icon: "shield", title: "C'est Légitime ?", description: "Oui. Vous détenez des parts dans une entité légale (SPV) qui possède un bien réel. Régulation DIFC. 327M$ déployés. 40+ projets complétés. 2 500+ investisseurs. Greenbull Group valorisé à 230M€ avec 10+ ans d'historique. C'est réel." },
          { icon: "history", title: "Quels rendements sont réalistes ?", description: "Moyenne historique : ~20% par projet sur 12 à 18 mois. Fourchette : 15 à 52% selon le projet. Les performances passées ne garantissent pas les résultats futurs, mais notre processus est éprouvé sur 40+ projets. Nous vous montrons toute la gamme—pas juste les gagnants." },
          { icon: "clock", title: "Combien de temps l'Argent Est-il Bloqué ?", description: "Typiquement 6 à 18 mois par projet. Pas d'option de sortie anticipée actuellement. Assurez-vous d'être à l'aise avec la timeline complète avant d'investir. C'est du capital illiquide." }
        ]
      },
      faq: {
        title: "FAQ complète",
