    ...
    <section className="py-24 bg-brand-surface">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="text-center mb-16">
          ...
          <p className="text-base md:text-lg text-brand-muted max-w-3xl mx-auto leading-relaxed tracking-wide">
            {guarantees.subtitle}
          </p>
        </div>
          ...
          {guarantees.pillars.map((pillar, i) => {
            ...
            return (
              ...
              >
                ...
                <p className="text-base text-brand-muted leading-relaxed mb-3 min-h-[52px]">{pillar.headline}</p>
                <p className="text-base text-brand-muted leading-relaxed mb-3 min-h-[96px]">{pillar.description}</p>
                <p className="text-base text-brand-muted leading-relaxed mb-6 min-h-[72px]">{pillar.subtext}</p>
        ...
        <div className="bg-white rounded-3xl border border-brand-border p-8 md:p-10 shadow-sm mb-12">
          <h3 className="text-lg font-bold text-brand-dark mb-6 text-center">Investor safeguards at a glance</h3>
