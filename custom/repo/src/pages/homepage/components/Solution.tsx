  ...
  return (
    <section id="how-it-works" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-12">
          <h3 className="text-2xl md:text-3xl font-bold mb-8 text-center text-brand-dark tracking-wide">
        ...
        <div className="text-center">
          <a href="https://investdubai.my.smartcrowd.ae/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-brand-accent text-white px-8 py-4 rounded-full font-semibold hover:bg-brand-accent/90 transition-colors shadow-xl">
            {solution.cta}
