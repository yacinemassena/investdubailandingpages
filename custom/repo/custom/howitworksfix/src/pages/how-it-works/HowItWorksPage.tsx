...
const experienceFeatures = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1557200134-90327ee9fafa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
  },
];
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900 selection:bg-black selection:text-white">
      ...
      <section className="relative pt-32 pb-24 md:pt-48 md:pb-32 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center relative z-10">
          ...
          >
            <span className="inline-block px-4 py-1.5 bg-black/5 text-black text-xs font-bold uppercase tracking-widest rounded-full mb-6 border border-black/10">
              How It Works
            </span>
            <h1 className="text-5xl md:text-7xl font-bold text-black mb-6 leading-[1.1] tracking-tight">
              The investment <br className="hidden md:block" /> process,
              simplified.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a
                href="#"
                className="w-full sm:w-auto bg-black text-white px-8 py-4 rounded-full font-medium inline-flex items-center justify-center gap-2 shadow-xl shadow-black/20 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300"
              >
                Create Your Account <ArrowRight className="w-4 h-4" />
              </a>
              <a
                href="#experience"
                className="w-full sm:w-auto border border-gray-300 bg-white/50 backdrop-blur-md text-black px-8 py-4 rounded-full font-medium inline-flex items-center justify-center gap-2 hover:bg-white hover:border-gray-400 transition-all duration-300"
              >
                <Play className="w-4 h-4" /> See Investor Updates
              </a>
            </div>
          </motion.div>
        </div>
              ...
              {processSteps.map((step, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs font-bold uppercase tracking-widest ${isActive ? "text-black" : isPast ? "text-gray-800" : "text-gray-400"}`}
                    >
                      Step {step.number}
                    </span>
                  </button>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
          <div className="text-center mb-20">
            <span className="inline-block px-4 py-1.5 bg-white/10 text-white text-xs font-bold uppercase tracking-widest rounded-full mb-6 border border-white/10">
              After You Invest
            </span>
                    ...
                    <div className="flex justify-center md:justify-start md:pl-20">
                      <div className="relative inline-block">
                        ...
                        <div className="absolute -bottom-6 -left-6 flex items-center gap-3 z-[40]">
                          ...
                          <span className="text-xs font-bold text-white uppercase tracking-widest bg-black/80 backdrop-blur-xl px-4 py-2 rounded-full shadow-2xl border border-white/10">
                            {feature.highlight}
                          </span>
                        </div>
                      </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-black/50 rounded-[2rem] p-6 md:p-10 backdrop-blur-md border border-white/10">
                <div className="text-center">
                  ...
                  <div className="text-gray-400 mb-8 font-medium text-sm md:text-base">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center relative z-10">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                href="#"
                className="w-full sm:w-auto border border-gray-300 bg-white text-black px-8 py-4 rounded-full font-medium inline-flex items-center justify-center gap-2 hover:bg-gray-50 hover:border-gray-400 transition-all duration-300"
              >
